...
fun EditSongInfoDialog(
    ...
    var capo by remember { mutableStateOf(initialCapo) }
            ...
            Column(
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    Box(Modifier.weight(1f)) {
                        SimpleTextField(value = bpm, onValueChange = { bpm = it }, label = "BPM")
                    }
                    Box(Modifier.weight(1f)) {
                        SimpleTextField(value = capo, onValueChange = { capo = it }, label = "Capo")
                    }
                }
                Spacer(modifier = Modifier.height(12.dp))
                ...
                Row(horizontalArrangement = Arrangement.End, modifier = Modifier.fillMaxWidth()) {
                    ...
                    Button(
                        onClick = { onConfirm(title, artist, bpm, capo, tuning) },
